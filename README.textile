...
Create an @ariane.return_to@ render method to generate a return_to html link that that can be used in addition to the breadcrumb trail to return to the previous task.
